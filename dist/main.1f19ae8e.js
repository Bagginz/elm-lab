...
(function (scope) {
  ...
  */
  ...
  var author$project$Main$LoginResponse = function author$project$Main$LoginResponse(a) {
    return {
      $: 'LoginResponse',
      a: a
    };
  ...
  var elm$http$Http$post = function elm$http$Http$post(r) {
    return elm$http$Http$request({
      body: r.body,
      expect: r.expect,
      headers: _List_Nil,
  ...
  var author$project$Main$update = F2(function (msg, model) {
    switch (msg.$) {
      case 'Username':
        ...
        var currentModel = _Utils_update(model, {
          username: username
        });
  ...
  var author$project$Main$Login = {
    $: 'Login'
  };

  var author$project$Main$Password = function author$project$Main$Password(a) {
    return {
      $: 'Password',
      a: a
    };
  ...
  var author$project$Main$Username = function author$project$Main$Username(a) {
    return {
      $: 'Username',
      a: a
    };
  ...
  var author$project$Main$viewInput = F5(function (c, t, p, v, toMsg) {
    return A2(elm$html$Html$input, _List_fromArray([elm$html$Html$Attributes$class(c), elm$html$Html$Attributes$type_(t), elm$html$Html$Attributes$placeholder(p), elm$html$Html$Attributes$value(v), elm$html$Html$Events$onInput(toMsg)]), _List_Nil);
  });
  ...
  var elm$html$Html$Attributes$height = function elm$html$Html$Attributes$height(n) {
    return A2(_VirtualDom_attribute, 'height', elm$core$String$fromInt(n));
  };

  var elm$html$Html$Attributes$src = function elm$html$Html$Attributes$src(url) {
  ...
  var elm$html$Html$Attributes$width = function elm$html$Html$Attributes$width(n) {
  ...
  var author$project$Main$view = function author$project$Main$view(model) {
    return A2(elm$html$Html$div, _List_fromArray([elm$html$Html$Attributes$class('form-signin'), A2(elm$html$Html$Attributes$style, 'margin-top', '10%')]), _List_fromArray([A2(elm$html$Html$img, _List_fromArray([elm$html$Html$Attributes$src('./images/elmicon.png'), elm$html$Html$Attributes$width(72), elm$html$Html$Attributes$height(72), A2(elm$html$Html$Attributes$style, 'text-align', 'center')]), _List_Nil), A2(elm$html$Html$div, _List_fromArray([elm$html$Html$Attributes$class('header-text-signin')]), _List_fromArray([elm$html$Html$text('Please singn in')])), A2(elm$html$Html$div, _List_Nil, _List_fromArray([A5(author$project$Main$viewInput, 'form-control', 'text', 'Username', model.username, author$project$Main$Username)])), A2(elm$html$Html$div, _List_Nil, _List_fromArray([A5(author$project$Main$viewInput, 'form-control', 'password', 'Password', model.password, author$project$Main$Password)])), A2(elm$html$Html$div, _List_Nil, _List_fromArray([A2(elm$html$Html$button, _List_fromArray([elm$html$Html$Attributes$class('btn btn-lg btn-primary btn-block'), A2(elm$html$Html$Attributes$style, 'margin-top', '15px'), elm$html$Html$Events$onClick(author$project$Main$Login)]), _List_fromArray([elm$html$Html$text('Sign in')]))])), A2(elm$html$Html$div, _List_Nil, _List_fromArray([elm$html$Html$text(model.username)])), A2(elm$html$Html$div, _List_Nil, _List_fromArray([elm$html$Html$text(model.password)]))]));
  };
...
},{}],"../../Users/ITOPPLUS/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13152" + '/');
...
},{}]},{},["../../Users/ITOPPLUS/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","main.js"], null)
