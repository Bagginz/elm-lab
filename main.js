	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$src('./images/elmicon.png'),
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('header-text-signin')
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Please singn in')
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						A5(author$project$Main$viewInput, 'form-control', 'text', 'Username', model.username, author$project$Main$Username)
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						A5(author$project$Main$viewInput, 'form-control', 'password', 'Password', model.password, author$project$Main$Password)
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
